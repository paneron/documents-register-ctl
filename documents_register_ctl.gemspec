...
Gem::Specification.new do |spec|
  ...
  spec.summary       = "Manage documents and render them as a web site"
  spec.description   = "A CLI to manage documents-centric Paneron register data"
  spec.homepage      = "https://github.com/paneron/documents-register-ctl"
